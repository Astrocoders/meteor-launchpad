...
#
# $DOCKER_IMAGE_NAME - use to push the build to your own Docker Hub account (Default: astrocoders/meteor-launchpad)
...
if [[ "$CIRCLE_BRANCH" == "master" ]]; then
  ...
  if [[ "$VERSION" ]]; then
    ...
    IMAGE_NAME=${DOCKER_IMAGE_NAME:-"astrocoders/meteor-launchpad"}
